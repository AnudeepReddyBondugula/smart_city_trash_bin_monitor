...
if __name__ == "__main__":
    ...
    parser.add_argument("--count", type=int, default=50, help="Number of bins to generate.")
    parser.add_argument("--clear", action="store_true", help="Clear existing bins before seeding.")
